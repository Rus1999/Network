# oct/12/2022 11:43:15 by RouterOS 7.4
...
/ip ipsec proposal
set [ find default=yes ] enc-algorithms=aes-256-cbc lifetime=0s
/ip pool
add name=dhcp_pool0 ranges=192.168.3.2-192.168.3.254
add name=PPTP_pools ranges=172.21.12.2-172.21.12.254
add name=L2TP-pools ranges=172.16.61.2-172.16.61.254
/ip dhcp-server
add address-pool=dhcp_pool0 interface=ether3 lease-time=1d10m name=dhcp1
/ppp profile
add local-address=172.21.12.1 name=PPTP-profile remote-address=PPTP_pools \
    use-encryption=yes
add local-address=172.16.61.1 name=L2TP_profile remote-address=L2TP-pools \
...
/ppp secret
add name=pptp01 profile=PPTP-profile service=pptp
add name=pptp02 profile=PPTP-profile service=pptp
