# sep/10/2022 23:01:33 by RouterOS 7.4
...
add address-pool=dhcp_pool1 interface=ether4-vlan10 lease-time=1d10m name=\
    dhcp2
add address-pool=dhcp_pool2 interface=ether4-vlan20 lease-time=1d10m name=\
    dhcp3
add address-pool=dhcp_pool3 interface=ether4-vlan30 lease-time=1d10m name=\
    dhcp4
...
add address=10.10.10.1/24 interface=ether4-vlan10 network=10.10.10.0
add address=10.20.10.1/24 interface=ether4-vlan20 network=10.20.10.0
add address=10.30.10.1/24 interface=ether4-vlan30 network=10.30.10.0
/ip dhcp-client
